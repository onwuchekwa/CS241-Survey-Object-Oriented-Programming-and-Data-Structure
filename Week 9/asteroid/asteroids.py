...
class Game(arcade.Window):
    ...
    def check_keys(self):
        ...
        if arcade.key.UP in self.held_keys:
            self.ship.velocity.dx -= math.sin(math.radians(self.ship.angle + 90)) * SHIP_THRUST_AMOUNT
            self.ship.velocity.dy += math.cos(math.radians(self.ship.angle + 90)) * SHIP_THRUST_AMOUNT
